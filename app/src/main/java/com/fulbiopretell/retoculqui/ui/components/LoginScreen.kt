...
@Composable
fun LoginScreen(viewModel: UserAccountViewModel, navController: NavController) {
        ...
        Column(
            ...
            Box(
                ...
                Column(
                    ...
                    //Text(text = "Looks like you don't have an account. Let's create a new account for $email.", modifier = Modifier.padding(horizontal = 16.dp, vertical = 16.dp), color = Color.White)
